            ...
            <div class="container mx-auto">
                ...
                <div class="overflow-x-auto w-full px-4 bg-white rounded-b-lg shadow">
                    <table class="my-4 w-full divide-y divide-gray-300 text-center">
                        <?php foreach ($izin as $row):  $keterangan_izin= $row->keterangan_izin;?>
                        <?php echo $this->session->flashdata('message'); ?>
                        <form action="<?php echo base_url('karyawan/ ') ?>" enctype="multipart/form-data" method="post">
                            <div>
                                <label for="keterangan_izin" class="block text-gray-800 font-medium mb-2">Keterangan
                                    Izin</label>
                                <textarea id="keterangan_izin" name="keterangan_izin" rows="6"
                                    class="bg-gray-50 w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-blue-500"
                                    required><?php echo $keterangan_izin;?></textarea>
                            </div>
