...
if ($row->keterangan_izin == '-') {
    echo '<div>
            <button onclick="ubah_absen(' . $row->id . ')" class="px-4 py-2 bg-sky-500  text-white rounded  hover:bg-sky-200 focus:outline-none focus:ring focus:ring-sky-700 ">
                <i class="fas fa-pen-to-square"></i>  
            </button>
          </div>';
} else {
    echo '<div>
            <button onclick="ubah_izin(' . $row->id . ')" class="px-4 py-2 bg-sky-500  text-white rounded  hover:bg-sky-200 focus:outline-none focus:ring focus:ring-sky-700 ">
                <i class="fas fa-pen-to-square"></i>  
            </button>
          </div>';
}
?>
                      ...
                      if($row->status == 'done') {
                        echo '<div>
                        <button disabled class="px-4 py-2 bg-black  text-white rounded  hover:bg-black-200 focus:outline-none focus:ring focus:ring-rose-700"> <i
                        class="fa-solid fa-person-walking"></i></button>
                       </div>';
                      } else {
                        echo '<div>
                        <button id="pulang" onclick="pulang('. $row->id .')" class="px-4 py-2 bg-red-600  text-white rounded  hover:bg-red-200 focus:outline-none focus:ring focus:ring-sky-700"> <i
                        class="fa-solid fa-person-walking"></i></button>
                       </div>';
                      }
                      ?>
