...
<body>
                    ...
                    <table class="table table-striped table-hover ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-4 py-2 text-gray-700">
                                    <?php echo $row->nama_depan .'  '.$row->nama_belakang?></td>

                                <td class="whitespace-nowrap px-4 py-2 text-gray-700">
                                    <a href="<?php echo base_url('aksi/ubah_karyawan/') . $row->id_karyawan ?>"
                                        class="btn btn-sm btn-primary">Ubah</a>

                                    <button onclick="hapus(<?php echo $row->id_karyawan ?>)"
                                        class="btn btn-sm btn-danger">Hapus</button>
                                    <button onclick="pulang(<?php echo $row->id_karyawan ?>)"
                                        class="btn btn-sm btn-dark">Pulang</button>
                                </td>
    ...
    function hapus(id) {
        ...
        if (yes === true) {
            window.location.href = "<?php echo base_url('karyawan/hapus_siswa/') ?>" + id;
        }
    }
    </script>
